...
//			 monthDrpdwn.selectByIndex(month-1);
		...
		public void Takescreenshot(String snapname) {
            ...
            try {
                  ...
                  ProcessBuilder builder = new ProcessBuilder(batfilepath, System.getProperty("user.dir")+"\\ScreenShots\\"+snapname);
                  builder.start();
            } catch (IOException e) {
     ...
     public void Uploadfile2(String windowtitle, String fieldname, String fieldname1, String filelocn, String actionbtn) {
         
         try {
               String batfilepath=System.getProperty("user.dir")+"\\Resources\\Autoitexe\\Uploadfile1.exe";                   
                      //Runtime.getRuntime().exec(batfilepath,System.getProperty("user.dir")+"\\Resources\\Screenshots\\demo");
               System.out.println(batfilepath);  
               ProcessBuilder builder = new ProcessBuilder(batfilepath, windowtitle, fieldname, System.getProperty("user.dir")+"\\Resources", fieldname1, filelocn, actionbtn);
